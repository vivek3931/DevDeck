  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-lg)' }}>
      <ColorBlock color="lilac">
        ...
        <SoftwareAppSchema name="DevDeck lorem-ipsum-placeholder-generator" description="A free, secure developer tool." url="https://devdeck.com/dev/lorem-ipsum-placeholder-generator" />
